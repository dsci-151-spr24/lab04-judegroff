...
There are `r nrow(laquinta)` rows and `r ncol(laquinta)` columns. Each row represents the data for a single Denny's restaurant, and the variables are: `r names(laquinta)`.
